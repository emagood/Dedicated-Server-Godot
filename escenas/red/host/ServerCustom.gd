'''
arreglar el autoload el singleton y mejorar el evento de inicio de secion y usuarios 
vincular un protocolo del servidor 
no vusar id de usuario si no una capa 
no exponer informacion 
...
#
	...
	#Data.t_id[multiplayer_api.get_unique_id()] = porto
#
#
#
#
