...
func _on_texto_plano_pressed() -> void:
	...
	var menu = preload("res://escenas/mode_view/user_admin.tscn").instantiate()
	add_child(menu)
	prints("instancio escena")
	await get_tree().create_timer(3).timeout
...
func _on_binarios_pressed() -> void:
	...
	var menu = preload("res://escenas/modo_bin/elserver.tscn").instantiate()
	add_child(menu)
	prints("instancio escena")
	await get_tree().create_timer(3).timeout
...
func _on_prueba_de_bit_pressed() -> void:
	...
	var menu = preload("res://byte_bit.tscn").instantiate()
	add_child(menu)
	prints("instancio escena")
	await get_tree().create_timer(3).timeout
...
func _on_prueba_ram_pressed() -> void:
	var menu = preload("res://time_data_ram.tscn").instantiate()
	add_child(menu)
	prints("instancio escena")
